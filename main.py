...
FastAPI + HTML/JS interface. No Gradio. Just Gary.
"""
...
<div class="app">
  <div class="sidebar">
    <div>
      <div class="gary-title">🎩 Gary RéDeaux</div>
      <div class="gary-subtitle">He simply arrived.</div>
    </div>
    <button class="new-chat-btn" onclick="newChat()">+ New Chat</button>
    <label class="voice-toggle">
      <input type="checkbox" id="voiceToggle"> 🔊 Voice (Gary speaks)
    </label>
  ...
  <div class="main">
    ...
    <div class="input-area">
      <div class="input-wrap">
        <textarea id="msgInput" placeholder="Say something to Gary..." rows="1"
...
<script>
  ...
  async function newChat() {
    try {
      ...
      document.getElementById('messages').innerHTML =
        '<div class="empty-state" id="emptyState"><div class="icon">🎩</div><p>Say something to Gary.</p></div>';
      await loadThreads();
    } catch(e) { console.error(e); }
  }
  ...
  function appendMessage(role, content) {
    ...
    // Render italic actions like *adjusts cufflinks*
  ...
  function updateActiveThread() {
    document.querySelectorAll('.thread-item').forEach(el => {
      el.classList.toggle('active', parseInt(el.dataset.id) === currentThreadId);
    });
  }
